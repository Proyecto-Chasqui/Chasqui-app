...
import {shoppingCartSelected, shoppingCarts, unreadNotifications} from '../actions';
...
const mapDispatchToProps = dispatch => ({
  actions: bindActionCreators({shoppingCartSelected,shoppingCarts, unreadNotifications}, dispatch),
});
