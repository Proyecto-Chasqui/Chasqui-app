...
class AdressManagmentView extends React.PureComponent {
    ...
    handleSubmit(values) {
        if (!this.state.sendingData) {
            if (this.dataValid()) {
                Alert.alert('Aviso', 'Datos Validos!');
            } else {
            ...
            <View>
                ...
                <KeyboardAvoidingView>
                    <View style={styles.titleContainer}>
                        <Text style={styles.adressTitle}>Nueva dirección</Text>
                    </View>
                    <ScrollView style={{ height: Dimensions.get('window').height - 140 }}>
                        ...
                        <View style={styles.buttonContainer}>
                            <Button loading={this.state.sendingData} disabled={!this.state.dataChange} buttonStyle={{ height: 60, backgroundColor: '#80bfff', borderColor: "white", borderWidth: 1 }} titleStyle={{ fontSize: 20, }} onPress={this.handleSubmit} title="Siguiente" />
                        </View>
                    </ScrollView>
                </KeyboardAvoidingView>
            </View>
